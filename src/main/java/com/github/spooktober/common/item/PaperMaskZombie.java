...
public class PaperMaskZombie extends GeoArmorItem implements IAnimatable{

	private AnimationFactory factory = new AnimationFactory(this);
	private double UnusualEffectOffset = 2.3;

	public PaperMaskZombie(IArmorMaterial armorMaterial, EquipmentSlotType equipSlot, Properties properties) {
	...
	public void registerControllers(AnimationData data) {
		data.addAnimationController(new AnimationController<PaperMaskZombie>(this, "controller", 20, this::predicate));
