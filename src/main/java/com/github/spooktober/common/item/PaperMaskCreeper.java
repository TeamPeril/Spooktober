...
public class PaperMaskCreeper extends GeoArmorItem implements IAnimatable{

	private AnimationFactory factory = new AnimationFactory(this);
	private double UnusualEffectOffset = 2.3;

	public PaperMaskCreeper(IArmorMaterial armorMaterial, EquipmentSlotType equipSlot, Properties properties) {
	...
	public void registerControllers(AnimationData data) {
		data.addAnimationController(new AnimationController<PaperMaskCreeper>(this, "controller", 20, this::predicate));
