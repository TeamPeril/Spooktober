...
public class CandyGummyWorms extends Item{
	
	private static int EFFECT_DURATION = 200;
	private static int EFFECT_LEVEL = 1;
	private static float EFFECT_CHANCE = 1.0f;
	private static EffectInstance EFFECT_INSTANCE = new EffectInstance(Effects.DIG_SPEED, EFFECT_DURATION, EFFECT_LEVEL);
	...
	//Constructor
	public CandyGummyWorms(Properties properties) {
		super(properties
