...
public class CandyGumballs extends Item{
	
	private static int EFFECT_DURATION = 200;
	private static int EFFECT_LEVEL = 1;
	private static float EFFECT_CHANCE = 1.0f;
	private static EffectInstance EFFECT_INSTANCE = new EffectInstance(Effects.SLOW_FALLING, EFFECT_DURATION, EFFECT_LEVEL);
	...
	//Constructor
	public CandyGumballs(Properties properties) {
		super(properties
