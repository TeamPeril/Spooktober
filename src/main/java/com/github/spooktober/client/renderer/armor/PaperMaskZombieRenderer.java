...
import com.github.spooktober.client.model.armor.PaperMaskZombieModel;
...
public class PaperMaskZombieRenderer extends GeoArmorRenderer<PaperMaskZombie> {
	public PaperMaskZombieRenderer()
	{
		super(new PaperMaskZombieModel());
